...
<div class="main-header">
    ...
    <p>Tác giả: Vương Quỳnh Hoa - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0965 590 904</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vương Quỳnh Hoa - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0965 590 904</div>", unsafe_allow_html=True)
